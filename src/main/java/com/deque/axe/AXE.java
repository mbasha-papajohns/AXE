...
public class AXE {
	...
	private static String getContents(final URL script) {
		...
		//System.out.println("GET CONTENTS :: "+ sb.toString());
		//System.out.println("COMPLETE CONTENTS DONE");
		return sb.toString();
	}
	 ...
	 */
	public static String report(final JSONArray violations,String pageUrl) {
		final StringBuilder sb = new StringBuilder();
		sb
				.append("FOUND ")
				.append(violations.length())
				.append(" ACCESSIBILITY VIOLATIONS IN " + pageUrl)
	...
	public static class Builder {
		...
		public JSONObject analyze() {
			...
			if (includes.size() > 1 || excludes.size() > 0) {
                ...
                //System.out.println ("ANALYZE COMMAND IS :: "+command);

 ...
 */
public class LandingPage16_Dashboard_PastOrders_Test {
    ...
    private static final URL scriptUrl = LandingPage16_Dashboard_PastOrders_Test.class.getResource("/axe.min.js");
    ...
    public void Test() {
        ...
        LandingPage16_Dashboard_PastOrders_Test.callMeToWait(5000);
        ...
        //Past Order Page
        driver.findElement(By.xpath("//div[@class='dashboard']//a[contains(.,'Past Orders')]")).click();
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        LandingPage16_Dashboard_PastOrders_Test.callMeToWait(5000);

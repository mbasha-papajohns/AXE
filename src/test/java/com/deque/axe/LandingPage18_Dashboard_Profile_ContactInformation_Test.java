 ...
 */
public class LandingPage18_Dashboard_Profile_ContactInformation_Test {
    ...
    private static final URL scriptUrl = LandingPage18_Dashboard_Profile_ContactInformation_Test.class.getResource("/axe.min.js");
    ...
    public void Test() {
        ...
        LandingPage18_Dashboard_Profile_ContactInformation_Test.callMeToWait(5000);
        ...
        //Profile_ContactInformation Page
        driver.findElement(By.xpath("//div[@class='dashboard']//a[@id='profile-panel-button']")).click();
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        LandingPage18_Dashboard_Profile_ContactInformation_Test.callMeToWait(5000);

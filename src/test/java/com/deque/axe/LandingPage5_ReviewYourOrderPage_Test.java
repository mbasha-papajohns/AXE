 ...
 */
public class LandingPage5_ReviewYourOrderPage_Test {
    ...
    private static final URL scriptUrl = LandingPage5_ReviewYourOrderPage_Test.class.getResource("/axe.min.js");
    ...
    public void Test() {
        ...
        LandingPage5_ReviewYourOrderPage_Test.callMeToWait(5000);
        ...
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        LandingPage2_MenuPage_Test.callMeToWait(5000);

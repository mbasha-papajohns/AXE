 ...
 */
public class LandingPage14_MenuPage_Favorites_Test {
    ...
    private static final URL scriptUrl = LandingPage14_MenuPage_Favorites_Test.class.getResource("/axe.min.js");
    ...
    public void Test() {
        ...
        LandingPage14_MenuPage_Favorites_Test.callMeToWait(5000);
        ...
        // Favorites Page
        driver.findElement(By.xpath("//div[@class='omnibar-wrap orderflow-page']//li[@class='omnibar-nav-favorites omnibar-nav-item']" +
                "/a[@data-omnibar-trigger='favorites']")).click(); // submit sign in
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        LandingPage14_MenuPage_Favorites_Test.callMeToWait(5000);

 ...
 */
public class LandingPage11_MenuPage_Extras_Test {
    ...
    private static final URL scriptUrl = LandingPage11_MenuPage_Extras_Test.class.getResource("/axe.min.js");
    ...
    public void Test() {
        ...
        LandingPage11_MenuPage_Extras_Test.callMeToWait(5000);
        ...
        // Menu_Extras Page
        driver.findElement(By.xpath("//nav[@class='secondary-nav']//li[@class='secondary-nav-item']//a[contains(.,'Extras')]")).click(); // submit sign in
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        LandingPage11_MenuPage_Extras_Test.callMeToWait(5000);

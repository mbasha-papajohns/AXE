 ...
 */
public class LandingPage13_MenuPage_Drinks_Test {
    ...
    private static final URL scriptUrl = LandingPage13_MenuPage_Drinks_Test.class.getResource("/axe.min.js");
    ...
    public void Test() {
        ...
        LandingPage13_MenuPage_Drinks_Test.callMeToWait(5000);
        ...
        // Menu_Drinks Page
        driver.findElement(By.xpath("//nav[@class='secondary-nav']//li[@class='secondary-nav-item']//a[contains(.,'Drinks')]")).click(); // submit sign in
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        LandingPage13_MenuPage_Drinks_Test.callMeToWait(5000);

 ...
 */
public class LandingPage9_SpecialsPage_Test {
    ...
    private static final URL scriptUrl = LandingPage9_SpecialsPage_Test.class.getResource("/axe.min.js");
    ...
    public void Test() {
        ...
        LandingPage9_SpecialsPage_Test.callMeToWait(5000);
        ...
        // submit sign in
        //User is already in Menu page
        driver.findElement(By.xpath("//input[@value='Sign In']")).click(); // submit sign in
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        LandingPage9_SpecialsPage_Test.callMeToWait(5000);

        //Navigate to Specials Page
        driver.findElement(By.xpath("//div[@class='wrap']//ul[@class='primary-nav-list inline-list']//a[contains(.,'Specials')]")).click();
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        LandingPage9_SpecialsPage_Test.callMeToWait(5000);

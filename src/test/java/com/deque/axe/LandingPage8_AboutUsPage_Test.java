 ...
 */
public class LandingPage8_AboutUsPage_Test {
    ...
    private static final URL scriptUrl = LandingPage8_AboutUsPage_Test.class.getResource("/axe.min.js");
    ...
    public void Test() {
       ...
       // driver.manage().deleteAllCookies();
        ...
        LandingPage8_AboutUsPage_Test.callMeToWait(5000);
        ...
        driver.findElement(By.xpath("//div[@class='utility-nav-wrap wrap']//li[@class='utility-nav-item']/a[contains(.,'About Us')]")).click();
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        LandingPage8_AboutUsPage_Test.callMeToWait(5000);

 ...
 */
public class LandingPage4_CheckoutPage_Test {
    ...
    private static final URL scriptUrl = LandingPage4_CheckoutPage_Test.class.getResource("/axe.min.js");
    ...
    public void Test() {
        ...
        LandingPage4_CheckoutPage_Test.callMeToWait(5000);

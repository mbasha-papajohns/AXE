 ...
 */
public class LandingPage10_MenuPage_Desserts_Test {
    ...
    private static final URL scriptUrl = LandingPage10_MenuPage_Desserts_Test.class.getResource("/axe.min.js");
    ...
    public void Test() {
        ...
        LandingPage10_MenuPage_Desserts_Test.callMeToWait(5000);
        ...
        // Favorites Page
        driver.findElement(By.xpath("//nav[@class='secondary-nav']//li[@class='secondary-nav-item']//a[contains(.,'Desserts')]")).click(); // submit sign in
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        LandingPage10_MenuPage_Desserts_Test.callMeToWait(5000);
